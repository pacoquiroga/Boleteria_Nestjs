import { IsDate, IsNotEmpty, IsNumber, IsEnum, IsArray, ValidateNested, IsOptional, IsString, IsEmail } from "class-validator";
...
export class CreateTransactionDto {
    ...
    @IsNotEmpty()
    @IsOptional()
    @IsEnum(PaymentMethod, { message: 'El método de pago debe ser un valor válido' })
